  ...
  state = {
    questions: [
      ...
      },
      {
        ...
        answer:
          "The percentage represents how much of a piece of news is fake.",
      },
      {
        count: "5",
      ...
      },
      {
        ...
        answer:
          "Yes, you can access it. To do so, you need to go to Settings > Preferences Settings and search for the specific provider and click on its avatar.",
      },
      {
        count: "7",
